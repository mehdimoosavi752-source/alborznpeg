...
export const DEFAULT_CONTENT = {
  settings: {
    ...
    repairSuccessRate: 95,
    returnPolicyDays: 7,
    serviceAreas: ["کرج", "فردیس", "گوهردشت", "اندیشه", "ملارد", "مهرشهر", "عظیمیه"],
  },
  beforeAfter: [],
  testimonials: [],
  hero: {
  ...
  services: [
    {
      ...
      slug: "hard-data-recovery",
      estimatedTime: { fa: "۱ تا ۳ روز کاری، بسته به شدت آسیب", en: "1–3 business days, depending on severity" },
    ...
    },
    {
      ...
      estimatedTime: { fa: "معمولاً همان روز تا ۲ روز کاری", en: "Usually same-day to 2 business days" },
    ...
    },
    {
      ...
      slug: "ps4-ps5-repair",
      estimatedTime: { fa: "۳۰ دقیقه تا ۲ ساعت برای اکثر ایرادها", en: "30 minutes to 2 hours for most faults" },
    ...
    },
    {
      ...
      slug: "full-system-overhaul",
      estimatedTime: { fa: "حدود ۲ تا ۴ ساعت", en: "About 2–4 hours" },
    ...
    },
    {
      ...
      slug: "projector-service-calibration",
      estimatedTime: { fa: "حدود ۱ ساعت (به‌جز زمان تهیه لامپ)", en: "About 1 hour (excluding lamp sourcing time)" },
